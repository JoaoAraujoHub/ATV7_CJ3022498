...
do
{
    do
    {
        ...
        Console.WriteLine("digite 1 para EXERCICIO1");
        Console.WriteLine("digite 2 para EXERCICIO2");
        Console.WriteLine("digite 3 para EXERCICIO3");
        Console.WriteLine("digite 4 para EXERCICIO4");
        Console.WriteLine("digite 5 para EXERCICIO5");
        Console.WriteLine("digite 6 para EXERCICIO6");
        Console.WriteLine("digite 7 para EXERCICIO7");
